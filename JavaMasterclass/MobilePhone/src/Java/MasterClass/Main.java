...
TIP: In MobilePhone, use findContact() in the other methods (except printContacts()) to check
...
public class Main {
    ...
    public static void main(String[] args) {
        MobilePhone myPhone = new MobilePhone("987654321");
        myPhone.addNewContact(new Contact("Bob", "31415926"));
        myPhone.addNewContact(new Contact("Alice", "16180339"));
        myPhone.addNewContact(new Contact("Tom", "11235813"));
        myPhone.addNewContact(new Contact("Jane", "23571113"));

        myPhone.printContacts();
        System.out.println();

        if (myPhone.addNewContact(Contact.createContact("Bob", "31415926"))) {
            System.out.println("Contact successfully created.\n");
        } else {
            System.out.println("Unable to create contact.\n");
        }

        if (myPhone.addNewContact(Contact.createContact("Sam", "554987354"))) {
            System.out.println("Contact successfully created.\n");
        } else {
            System.out.println("Unable to create contact.\n");
        }
        ...
        if (myPhone.updateContact(Contact.createContact("Bob", "31415926"),
                Contact.createContact("Bob", "9955446625"))) {
            System.out.println("Contact successfully updated.\n");
        } else {
            System.out.println("Unable to update contact.\n");
        }

        if (myPhone.updateContact(Contact.createContact("Sam", "31415926"),
                Contact.createContact("Bob", "9955446625"))) {
            System.out.println("Contact successfully updated.\n");
        } else {
            System.out.println("Unable to update contact.\n");
        ...
        if (myPhone.removeContact(Contact.createContact("Tom", "11235813"))) {
            System.out.println("Contact successfully removed.\n");
        } else {
            System.out.println("Unable to remove contact.\n");
        }

        if (myPhone.removeContact(Contact.createContact("Sam", "11235813"))) {
            System.out.println("Contact successfully removed.\n");
        } else {
            System.out.println("Unable to remove contact.\n");
        }
        ...
        Contact contact = myPhone.queryContact("Alice");
