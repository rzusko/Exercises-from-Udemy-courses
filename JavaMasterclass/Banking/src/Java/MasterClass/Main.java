...
1. Bank
    ...
    - It has two fields, A String called name
        and an ArrayList that holds objects of type Branch called branches.
...
2. Branch
    ...
    - It has two fields, A String called name
        and an ArrayList that holds objects of type Customer called customers.
    ...
    - And five methods, they are (their functions are in their names):
        ...
        - addCustomerTransaction(), has two parameters of type String (name of customer),
            double (transaction) and returns a boolean.
...
3. Customer
    ...
    - It has two fields, A String called name
        and an ArrayList that holds objects of type Double called transactions.
