// The purpose of the application is to help a fictitious company
...
//        Hamburger hamburger = new Hamburger("Basic Burger", new OnionBreadRoll(), new Meat());
//        hamburger.add(new Bacon());
//        hamburger.add(new Cheese());
//        hamburger.showPrices();
//        hamburger.add(new Onion());
//        hamburger.add(new Lettuce());
//        hamburger.add(new Tomato());
//        hamburger.showPrices();

//        HealthyBurger healthyBurger = new HealthyBurger(new Meat());
//        healthyBurger.setBread(new SesameSeedBreadRoll());
//        healthyBurger.add(new Bacon());
//        healthyBurger.add(new Onion());
//        healthyBurger.add(new Tomato());
//        healthyBurger.add(new Lettuce());
//        healthyBurger.showPrices();
//        healthyBurger.add(new Cheese());
//        healthyBurger.add(new Carrot());
//        healthyBurger.add(new CocaCola());
//        healthyBurger.showPrices();

        DeluxeBurger deluxeBurger = new DeluxeBurger(new KaiserBreadRoll(), new Meat(), new Fanta());
        deluxeBurger.setBread(new PotatoBreadRoll());
        deluxeBurger.add(new Bacon());
