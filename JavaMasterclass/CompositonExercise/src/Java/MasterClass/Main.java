 ...
 *      All variable should be marked private.
 ...
 *      - getSheets() - returns the number of sheets
 ...
 *      It contains one member variable:
 ...
 *      - makeBed() - prints a message that the bed is being made
 *                      and also calls the make() method in the Bed class.
 *
 *  Input/Output:
 *
 *  Once you have completed coding your classes you should then use the following code
 *  in your main class to test your code and for correct output.
 *  This way you can be sure that your code works before pasting your five classes
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Bedroom bedRoom = new Bedroom("Radoslav", wall1, wall2, wall3, wall4, ceiling, bed, lamp);
        bedRoom.makeBed();
