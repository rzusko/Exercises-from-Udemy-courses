...
1. Album
    ...
    - And three methods, they are:
        ...
        - addToPlayList(), has two parameters of type String (title of song)
            and LinkedList (the playlist) that holds objects of type Song, and returns a boolean.
            Returns true if it exists and it was added successfully using the name of the song,
            or false otherwise.
...
2. Song
    ...
    - And two methods, they are:
        ...
        - toString(), Songs overriding toString method. Returns a String in the following format:
            "title: duration"
...
TIP: In Album, use the findSong() method in addSong() and addToPlayList(String, LinkedList)
